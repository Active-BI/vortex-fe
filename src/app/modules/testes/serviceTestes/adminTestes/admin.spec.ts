...
//             seuService.getUsers().subscribe((response: getAllRequest[]) => {});
...
//             seuService.getUserById(id).subscribe((e: getAllRequest) => {
...
//             seuService.updateUser(mockItem).subscribe(() => {});
...
//         it('Se payload e Url estão corretos', () => {
//             seuService.deleteUser(id).subscribe(() => {});
//             const httpRequest = httpMock.expectOne(
//                 `${baseUrl}admin?userId=${id}`
//             );
...
//         it('Se payload e Url estão corretos', () => {
//             seuService.preRegister(mockItem).subscribe(() => {});
...
//             seuService.getVisions().subscribe((e: ImockVision[]) => {
//                 expect(e.length).toEqual(1);
...
//         });
//         it('Testa se o método e o endpoint estão corretos', () => {
//             seuService.getVisions().subscribe((response: ImockVision[]) => {});
