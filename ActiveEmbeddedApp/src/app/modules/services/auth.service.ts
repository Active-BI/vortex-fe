...
const urlLogout = 'https://wfs-ish.ish.com.br/adfs/oauth2/logout?client_id=3bc4f023-cdc0-48dc-8d10-9fdd6b1d523d'
...
saveUserLoggedIn(token:string){
  ...
  this.updateUserLogin({email:decodedToken.email, name:decodedToken.email})
}
